...
import srplogo from '../../../../../public/srplogo.jpeg'
...
const Nav = () => {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <header className="relative h-18 px-8 mx-auto border-b duration-200 bg-srpblue-0 border-ui-border-base ">
        <nav className="txt-xsmall-plus text-ui-fg-subtle flex items-center justify-between w-full h-full text-small-regular">
          <div className="flex-1 basis-0 h-full flex items-center">
            ...
            <div className="hidden small:block h-full text-white">
